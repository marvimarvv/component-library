...
const buttonStyles = cva(
  "pointer-cursor rounded-skin font-bold visited:no-underline focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-skin-primary-500 focus-visible:outline-offset-2",
  {
    variants: {
      ...
      theme: {
        "gradient-theme":
          "gradient-theme-button bg-gradient-to-br from-skin-primary-300 via-skin-primary-700 to-skin-primary-300 font-normal dark:from-skin-primary-100 dark:via-skin-primary-300 dark:to-skin-primary-100 dark:text-skin-primary-700",
        "neon-theme":
    ...
    compoundVariants: [
      {
        ...
        class:
          "relative text-transparent dark:text-transparent after bg-clip-text before:bg-gradient-to-br before:from-skin-primary-300 before:via-skin-primary-700 before:to-skin-primary-300 before:absolute before:inset-0 before:rounded-skin before:-z-20 after:absolute after:inset-[0.18rem] after:bg-skin-background after:-z-10 after:rounded-skin dark:before:from-skin-primary-100 dark:before:via-skin-primary-300 dark:before:to-skin-primary-100",
      },
      {
        intent: "secondary",
        theme: "neon-theme",

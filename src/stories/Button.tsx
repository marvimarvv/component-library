...
const buttonStyles = cva(
  "pointer-cursor rounded-skin font-bold visited:no-underline focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-skin-primary-500 focus-visible:outline-offset-2",
  {
    variants: {
      ...
      theme: {
        "gradient-theme":
          "gradient-theme-button bg-linear-to-br from-skin-primary-300 via-skin-primary-700 to-skin-primary-300 font-normal dark:from-skin-primary-100 dark:via-skin-primary-300 dark:to-skin-primary-100 dark:text-skin-primary-700",
        "neon-theme":
